AFRAME.registerComponent("cuisine", {
    schema: {
    ...
    tick: function() {
      const { state } = this.el.getAttribute("cuisine");
      ...
      const thumbNailsRef = [
        {
          ...
          url: "./assets/thumbnails/chicken-fajitas.jpg"
        },
        {
          id: "French Cuisine",
          title: "Ratatouille",
          url: "./assets/thumbnails/ratatouille.webp"
        },
  
        {
          id: "Indian Cuisine",
          title: "Butter Chicken",
          url: "./assets/thumbnails/butter-chicken.jpg"
        },
        {
          id: "Chinese Cuisine",
          title: "Squirrel Fish",
          url: "./assets/thumbnails/squirrel-fish.jpg"
        }
      ];
