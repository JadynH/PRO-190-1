AFRAME.registerComponent("cursor-listener", {
    ...
    handleClickEvents: function() {
      ...
      this.el.addEventListener("click", evt => {
        ...
        const { state } = placesContainer.getAttribute("cuisine");
        ...
        if (state === "places-list") {
          ...
          if (placesId.includes(id)) {
            placesContainer.setAttribute("cuisine", {
              state: "view",
              selectedCard: id
            });
          }
    ...
    handleMouseEnterEvents: function() {
      ...
      this.el.addEventListener("mouseenter", () => {
        ...
        const { state } = placeContainer.getAttribute("cuisine");
        if (state === "places-list") {
    ...
    handlePlacesListState: function() {
      const id = this.el.getAttribute("id");
      const placesId = ["American Cuisine", "French Cuisine", "Indian Cuisine", "Chinese Cuisine"];
      if (placesId.includes(id)) {
        const placeContainer = document.querySelector("#places-container");
